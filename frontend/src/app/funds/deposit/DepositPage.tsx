        ...
        ws.onmessage = (event) => {
          try {
            ...
            if (currentDepositInfo.memo && data.memo) {
              ...
              if (String(data.memo) === String(currentDepositInfo.memo) && data.status) {
                console.log('DepositPage: Memo совпадает, статус:', data.status);
                if (data.status === 'used' || data.status === 'completed' || data.status === 'confirmed') {
            ...
            if (currentDepositInfo.address && data.address) {
              ...
              if (String(data.address).toLowerCase() === String(currentDepositInfo.address).toLowerCase() && data.status) {
