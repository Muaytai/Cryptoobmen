...
const HomePageContent = () => {
    ...
    const getResponsiveStyles = () => {
      ...
      return {
        ...
        contentContainer: {
          ...
          minHeight: isMobile ? 400 : 500, // Фиксированная минимальная высота
          height: isMobile ? 400 : 500 // Фиксированная высота
        } as CSSProperties,
        ...
        imageContainer: {
          ...
          minHeight: isSmallMobile ? 250 : isMobile ? 300 : isTablet ? 400 : 520, // Фиксированная высота
          minWidth: isMobile ? '100%' : isTablet ? 400 : 520 // Фиксированная ширина
        } as CSSProperties,
        ...
        cryptoIconsContainer: {
          ...
          marginBottom: 80,
          overflow: 'hidden',
          minHeight: 70, // Фиксированная высота
          height: 70
        } as CSSProperties,
  ...
  return (
    <div className={`relative h-full ${isDarkMode ? 'bg-[#111014]' : 'bg-white'}`} style={{ contain: 'layout' }}>
      <main style={{
        height: '100%',
        maxWidth: 1400, 
        margin: '0 auto',
