...
export const DivByAnima = (): JSX.Element => {
  ...
  return (
    <div className={clsx(styles.container, "bg-card")}>
      {/* Cards Grid */}
      <div className={styles.cardsGrid}>
        ...
        {/* User Info Cards */}
        <Card className={clsx(styles.div2, "bg-subcard rounded-[15px]")}>
        ...
        <Card className={clsx(styles.div5, "bg-subcard rounded-[15px]")}>
          <CardContent className="p-3 md:p-5 h-[80px] md:h-[104px]">
            <span className="font-medium text-subcard-text/60 text-xs md:text-sm [font-family:'Manrope',Helvetica]">
              VIP уровень
            </span>
        ...
        <Card
          className={clsx(styles.div6, "bg-subcard rounded-[15px] col-span-2")}
        >
          <CardContent className="p-3 md:p-5 h-[180px] md:h-[214px] relative">
            ...
            <div className="mt-6 md:mt-[38px] font-normal text-subcard-text text-2xl md:text-[32px] [font-family:'Manrope',Helvetica]">
        ...
        {/* Email Card */}
        <Card
          className={clsx(styles.div7, "bg-subcard rounded-[15px] col-span-2")}
        >
          <CardContent className="p-3 md:p-5 h-[80px] md:h-[104px] relative">
            <span className="font-medium text-subcard-text/60 text-xs md:text-sm [font-family:'Manrope',Helvetica]">
              Почта
        ...
        <Card
          className={clsx(styles.div8, "bg-subcard rounded-[15px] col-span-2")}
        >
          <CardContent className="p-3 md:p-5 h-[180px] md:h-[214px] relative">
            <div className="flex items-center">
        ...
        {/* Referral Link Card */}
        <Card
          className={clsx(styles.div9, "bg-subcard rounded-[15px] col-span-2")}
        >
          <CardContent className="p-3 md:p-5 h-[80px] md:h-[104px] relative">
            <span className="font-medium text-subcard-text/60 text-xs md:text-sm [font-family:'Manrope',Helvetica]">
              Реферальная ссылка
