        ...
        {cryptoData.map((crypto) => (
          <Card key={crypto.id} className={styles.cryptoCard}>
            <CardContent className={styles.cardContent}>
              ...
              {/* Stats Section */}
              <div className="w-full h-12 bg-gray-100 rounded-[15px] mb-5 flex items-center justify-between px-5">
                <div className="inline-flex items-center gap-2.5">
                  <div className="font-normal text-[#1a1a1a] text-sm [font-family:'Manrope',Helvetica]">
                    День:
                  </div>
                  <div className="font-normal text-[#1a1a1a] text-sm [font-family:'Manrope',Helvetica]">
                    0.00%
