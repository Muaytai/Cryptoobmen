    ...
    <section className={styles.container}>
      ...
      >
        ...
        >
          <CardContent className="p-3 md:p-5 h-[80px] md:h-[104px] relative">
            <div className="flex w-full items-center justify-between ">
              <span className="font-medium mb-8 text-subcard-text text-base md:text-lg [font-family:'Manrope',Helvetica] ">
                Доход
              </span>
            </div>
            <div className="flex w-full items-center justify-between ">
            ...
            <div className="flex w-full items-center justify-between ">
              <span className="font-medium mt-6 text-subcard-text text-base md:text-lg [font-family:'Manrope',Helvetica] ">
                USDT
              </span>
            </div>
            <div
        ...
        <Card className="flex gap-4 w-full p-5 mb-[160px] text-subcard-text shadow-[0px_0px_20px_#0000004c] rounded-[15px] md:rounded-[25px] ">
          <CardContent className="w-full p-0 md:p-0">
            <div className="w-full max-w-full bg-card rounded-lg overflow-hidden">
              ...
              >
                <div className="px-4 py-3 bg-subcard text-left font-medium text-subcard-text text-base md:text-lg  tracking-wider border-b border-subcard">
                  Номер
                </div>
                <div className="px-4 py-3 bg-subcard text-left font-medium text-subcard-text text-base md:text-lg  tracking-wider border-b border-subcard">
                  Дата регистрации
