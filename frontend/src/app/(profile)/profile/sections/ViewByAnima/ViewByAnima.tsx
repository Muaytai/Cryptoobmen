      ...
      <div className={styles.content}>
        ...
        <Card
          ...
          <CardContent className="p-0 md:p-0">
            ...
            <h3 className="font-medium text-lg md:text-xl text-[#1a1a1a] mt-5">
          ...
          <div
            className="w-[50%] mt-8 md:mt-0 md:top-5 md:right-5 bg-gray-100 rounded-[15px] p-4 md:p-0">
            <img
          ...
          <CardContent className="p-4 md:p-5">
            ...
            {userWinnings.map((user, index) => (
              <div key={index} className="flex items-center mb-4 md:mb-5">
                <div
                  className="flex items-center shrink-0 justify-center mr-3 md:mr-4">
                  <img
